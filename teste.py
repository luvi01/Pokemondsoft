# -*- coding: utf-8 -*-
"""
Created on Wed May 16 16:07:28 2018
...
tela = pygame.display.set_mode((1600, 1200), 0, 32)
...
while rodando:
    ...
    parede=Parede(vx,vy,10,600)
    lista_paredes.add(parede)
    all_sprite_list.add(parede)
    
    parede_LADO=Parede(vx+790,vy,10,600)
    parede_LADO1=Parede(vx+790,vy,10,600)
    lista_paredes.add(parede_LADO)
    lista_paredes.add(parede_LADO1)
    all_sprite_list.add(parede_LADO)
    all_sprite_list.add(parede_LADO1)
    all_sprite_list.remove(parede_LADO1)
    lista_paredes.remove(parede_LADO1)
